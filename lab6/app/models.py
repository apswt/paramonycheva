...
from sqlalchemy import String, ForeignKey, Text, Integer, MetaData, UniqueConstraint, CheckConstraint
...
class Review(Base):
    ...
    def __repr__(self):
        return f'<Review {self.id} course={self.course_id} user={self.user_id}>'
